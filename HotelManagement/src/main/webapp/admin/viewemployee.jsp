<%-- 
    ...
    Created on : Jul 11, 2021, 3:04:22 PM
    Author     : vicky
--%>
...
<html>
  ...
  <table class="table">
    ...
    <%
                         ...
                         PreparedStatement ps=con.prepareStatement("select * from reception");
    ...
    <tbody>
      <tr>
        ...
        <td><a href="Update.jsp?userid=<%=rs.getString("userid")%>">Update</a></td>
        <td><a href="delete.jsp?userid=<%=rs.getString("userid")%>">Delete</a></td>
      </tr>
    </tbody>
    <% }%>
  </table>
